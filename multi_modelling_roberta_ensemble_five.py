...
class RobertaForTemporalMulti(BertPreTrainedModel):
    ...
    def __init__(self, config, config_2, config_3, config_4, config_5):
        super().__init__(config, config_2, config_3, config_4, config_5)
        self.batch_size = 8
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        if task_name[0] == 1:
            ...
            stacked_sequence_output = torch.mean(torch.stack([sequence_output, sequence_output_2, sequence_output_3,
                                                              sequence_output_4, sequence_output_5]), 0)
