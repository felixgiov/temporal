...
from multi_trainer_aux import Trainer, set_seed
...
def main():
    ...
    timebank_timex_dev_dataset = None
    timebank_event_dev_dataset = None
    tb_duration_dev_dataset = None
    ...
    if training_args.do_train and multi_args.train_timex:
        ...
        timebank_timex_dev_examples = timebank_processor.get_dev_examples('')
        timebank_timex_dev_dataset = convert_timebank_examples_to_features(timebank_timex_dev_examples,
                                                                             timebank_timex_label_list,
                                                                             mctaco_data_args.max_seq_length,
                                                                             tokenizer,
                                                                             2,
    ...
    if training_args.do_train and multi_args.train_event:
        ...
        timebank_event_dev_examples = timebank_processor.get_dev_examples('')
        timebank_event_dev_dataset = convert_timebank_examples_to_features(timebank_event_dev_examples,
                                                                             timebank_event_label_list,
                                                                             mctaco_data_args.max_seq_length,
                                                                             tokenizer,
                                                                             3,
    ...
    if training_args.do_train and multi_args.train_duration:
        ...
        tb_duration_train_dataset = convert_tb_duration_examples_to_features(tb_duration_train_examples,
                                                                             ...
                                                                             mctaco_data_args.max_seq_length,
                                                                             tokenizer)
        tb_duration_dev_examples = tb_duration_processor.get_test_examples('')
        tb_duration_dev_dataset = convert_tb_duration_examples_to_features(tb_duration_dev_examples,
                                                                             tb_duration_label_list,
                                                                             mctaco_data_args.max_seq_length,
                                                                             tokenizer)
    ...
    def compute_metrics_2(p: EvalPrediction) -> Dict:
        preds = np.argmax(p.predictions, axis=1)
    ...
    trainer = Trainer(
        ...
        eval_dataset=matres_eval_dataset,  # change to mctaco_eval_dataset / dev_dataset
        test_dataset=matres_eval_dataset,
    ...
    # if training_args.do_predict:
        ...
        # preds = trainer.predict_timebank(matres_eval_dataset)
        ...
        #     for val in preds_argmax:
        #         if val == 0:
        #             pred_writer.write("OCCURRENCE\n")
        #         elif val == 1:
        #             pred_writer.write("PERCEPTION\n")
        #         elif val == 2:
        #             pred_writer.write("REPORTING\n")
        #         elif val == 3:
        #             pred_writer.write("ASPECTUAL\n")
        #         elif val == 4:
        #             pred_writer.write("STATE\n")
        #         elif val == 5:
        #             pred_writer.write("I_STATE\n")
        #         else:
        #             pred_writer.write("I_ACTION\n")
