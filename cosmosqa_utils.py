...
class CosmosQAProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        logger.info("LOOKING AT {} train".format(data_dir))
        return self._create_examples(self._read_csv(os.path.join(data_dir, "train_temporal.csv")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        logger.info("LOOKING AT {} dev".format(data_dir))
        return self._create_examples(self._read_csv(os.path.join(data_dir, "valid_temporal.csv")), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        logger.info("LOOKING AT {} dev".format(data_dir))
        # return self._create_examples_test(self._read_csv(os.path.join(data_dir, "test.csv")), "test")
        return self._create_examples(self._read_csv(os.path.join(data_dir, "valid_temporal.csv")), "test")
    ...
    def _create_examples_test(self, lines: List[List[str]], type: str):
        """Creates examples for the training and dev sets."""
...
processors = {"race": RaceProcessor, "swag": SwagProcessor, "arc": ArcProcessor, "syn": SynonymProcessor, "cos": CosmosQAProcessor}
MULTIPLE_CHOICE_TASKS_NUM_LABELS = {"race", 4, "swag", 4, "arc", 4, "syn", 5, "cos", 4}