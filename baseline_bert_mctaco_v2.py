...
from baseline2v2 import ModelArguments
...
def main():
    ...
    tokenizer = BertTokenizer.from_pretrained(model_args.model_name_or_path, do_lower_case=args.do_lower_case)
    ...
    config = BertConfig.from_pretrained(model_args.model_name_or_path, num_labels=2)
