...
from multi_modelling_roberta_ensemble import RobertaForTemporalMulti
...
class ModelArguments:
    ...
    model_name_or_path_16: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_17: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_18: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_19: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_20: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_21: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_22: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_23: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_24: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_25: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_26: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_27: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_28: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_29: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    model_name_or_path_30: str = field(
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
...
def main():
    ...
    mctaco_config_16 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_16,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_17 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_17,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_18 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_18,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_19 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_19,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_20 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_20,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_21 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_21,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_22 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_22,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_23 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_23,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_24 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_24,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_25 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_25,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_26 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_26,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_27 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_27,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_28 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_28,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_29 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_29,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    mctaco_config_30 = RobertaConfig.from_pretrained(
        model_args.model_name_or_path_30,
        num_labels=mctaco_num_labels,
        cache_dir=model_args.cache_dir,
    )
    ...
    multitask_model = RobertaForTemporalMulti.from_pretrained(
        ...
        config_16=mctaco_config_16,
        config_17=mctaco_config_17,
        config_18=mctaco_config_18,
        config_19=mctaco_config_19,
        config_20=mctaco_config_20,
        config_21=mctaco_config_21,
        config_22=mctaco_config_22,
        config_23=mctaco_config_23,
        config_24=mctaco_config_24,
        config_25=mctaco_config_25,
        config_26=mctaco_config_26,
        config_27=mctaco_config_27,
        config_28=mctaco_config_28,
        config_29=mctaco_config_29,
        config_30=mctaco_config_30,
        cache_dir=model_args.cache_dir,
        # params=params,
