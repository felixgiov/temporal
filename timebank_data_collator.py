...
class DefaultDataCollator(DataCollator):
    ...
    def collate_batch(self, features: List[InputDataClass]) -> Dict[str, torch.Tensor]:
        ...
        # if hasattr(first, "ner_token_ids") and first.ner_token_ids is not None:
        #     print(first.ner_token_ids)
        #     ner_segments = torch.tensor([f.label_ids for f in features], dtype=torch.long)
        #     batch = {"ner_segments": ner_segments}
        # else:
        #     batch = {}
