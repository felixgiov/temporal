...
class LabelAccuracyEvaluator(SentenceEvaluator):
    ...
    def __init__(self, dataloader: DataLoader, name: str = "", softmax_model = None):
        ...
        self.txt_file = "pred_results_sbert" + name + "_results.txt"
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        for step, batch in enumerate(tqdm(self.dataloader, desc="Evaluating")):
            ...
            preds.append(torch.argmax(prediction, dim=1))
        ...
        if output_path is not None and epoch == 2:
            txt_path = os.path.join(output_path, self.txt_file)
