...
class RobertaForTemporalMulti(BertPreTrainedModel):
    ...
    def __init__(self, config, config_2, config_3, config_4, config_5, config_6, config_7, config_8, config_9, config_10, config_11, config_12, config_13, config_14, config_15):
        super().__init__(config, config_2, config_3, config_4, config_5, config_6, config_7, config_8, config_9, config_10, config_11, config_12, config_13, config_14, config_15)
        self.batch_size = 8
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        if task_name[0] == 1:
            ...
            sequence_output_11 = outputs_11[0]
            sequence_output_12 = outputs_12[0]
            sequence_output_13 = outputs_13[0]
            sequence_output_14 = outputs_14[0]
            sequence_output_15 = outputs_15[0]

            # stacked_sequence_output = torch.mean(torch.stack([sequence_output, sequence_output_2, sequence_output_3,
            #                                                   sequence_output_4, sequence_output_5, sequence_output_6,
            #                                                   sequence_output_7, sequence_output_8, sequence_output_9,
            #                                                   sequence_output_10, sequence_output_11, sequence_output_12,
            #                                                   sequence_output_13, sequence_output_14, sequence_output_15]), 0)
            #
            ...
            logits11 = self.classifier(sequence_output_11)
            logits12 = self.classifier(sequence_output_12)
            logits13 = self.classifier(sequence_output_13)
            logits14 = self.classifier(sequence_output_14)
            logits15 = self.classifier(sequence_output_15)
