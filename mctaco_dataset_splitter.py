...
path_new = '/home/felix/projects/research/datasets/MCTACO/percentage_splits/75/'
...
length = int(0.75 * len(dictionary))

train_1 = list[:length]

print("Train A : "+str(len(train_1)))

with open(path_new+"train.tsv", 'w') as writer:
    for item in train_1:
        for answer in item[1]:
            writer.write(item[0] + "\t" + answer)
